...
@section('head')
    ...
    <script>
         $.extend(ST.ACTION,{
            advanceBusList:"{{route('admin.advancecash.api.addmortgage-api')}}",  //录入发票展示相关业务列表 
...
@section('content')
            ...
            <form id="js-form-validate" action="{{route('admin.advancecash.storemortgage')}}" method="post">
            ...
            <table class="table table-listing table-hovered">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td  colspan="3">
                            <textarea name="remark" id="" cols="73" rows="5">预收款（单号：{{$mortgage->advancecash_key}}）转回款，开发票_（提交后自动填充）_元，回款金额_（提交后自动填充）_元</textarea>
                        </td>
                    </tr>
			...
			<div style="margin-left:200px;" >
							<input type="hidden" value="{{$mortgage->id}}" name="advancecash_id"   id="advancecash_id"/>
