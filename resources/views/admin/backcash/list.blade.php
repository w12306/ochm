...
@section('content')
	<script>
        $.extend(ST.ACTION,{
            refundList:"/authed/backcash/api/list-seach/",  //获取回款列表接口, 
            refundDelete:"{{ route('admin.backcash.delete') }}" //删除回款接口
        });
    </script>
    <div class="heading clearfix">
         ...
         <div class="pull-right">
             <a title="当前数据导出" href="javascript:;" class="btn mr5"
                    data-url="{{ route('admin.backcash.export-excel') }}"
...
<script>
    seajs.use('view/refund/list', function (app) {
        app({
            el:"#js-container"
        });
    });
