...
@section('content')
    ...
    <div class="heading clearfix">
         ...
         <div class="pull-right">
              <a title="新增产品信息" href="{{ route("admin.toolbox.create-undercompany") }}" class="btn mr5" >新增客户信息</a>    
         </div>
    </div>
    		...
    		<table class="table table-listing mt20 border-table">
				...
				@else
                    ...
                    <tr>
                        ...
                        <td>{{$d->id}}</td>-->
                        <td>
                            <a href="{{ route("admin.toolbox.create-undercompany",['id' => $d->id]) }}" class="js-product-edit"><i hidid="" class="icon i-edit" title="编辑"></i></a>
                        </td>
                    </tr>  
						@endforeach
				@endif	                 
