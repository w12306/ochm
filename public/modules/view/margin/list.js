define(function (require) {
    ...
    var Refund = require("view/margin/refund");
    ...
    var View = Base.View.extend({
        ...
        search:function(){
            ...
            if(!t.model){
                t.model = new M({url:ST.ACTION.marginList,data:searchData});
            }else{
        ...
        refund:function(t){
            ...
            var v = new Refund({
                ...
                company:company,
                title:title,
                url:ST.ACTION.marginRefund,
                listUrl:ST.ACTION.marginRefundList,
                deleteUrl:ST.ACTION.marginRefundDelete
            });
            v.on("close",function(){
                t.search();
            })
        ...
        deduct:function(t){
            ...
            var v = new Refund({
                ...
                company:company,
                title:title,
                url:ST.ACTION.marginDeduct,
                listUrl:ST.ACTION.marginDeductList,
                deleteUrl:ST.ACTION.marginDeductDelete
            });
            v.on("close",function(){
                t.search();
            });
