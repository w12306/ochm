...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        ,imageUrl:ST.ACTION.UPLOADUEDITOR       //图片上传提交地址
       ...
       //,imageFieldName:"upfile"                   //图片数据的key,若此处修改，需要在后台对应文件修改对应参数
        ...
        ,toolbars:[
            [
                ...
                'blockquote', '|', 'pasteplain', '|', 'insertorderedlist', 'insertunorderedlist', '|',
                'rowspacingtop', 'rowspacingbottom','lineheight', '|',
                'link', 'unlink',
                'insertimage', 'insertvideo', '|',
                'map', 'gmap', 'insertframe','template','background', '|',
                'horizontal', 'date', 'spechars', '|',
                'inserttable', 'deletetable', 'insertparagraphbeforetable', 'insertrow', 'deleterow', 'insertcol', 'deletecol', 'mergecells', 'mergeright', 'mergedown', 'splittocells', 'splittorows', 'splittocols', '|',
                'undo', 'redo', '|',
                'source',
                'bold', 'italic', 'underline', 'strikethrough', 'superscript', 'subscript', 'fontfamily', 'fontsize', 'forecolor', 'backcolor', '|',
